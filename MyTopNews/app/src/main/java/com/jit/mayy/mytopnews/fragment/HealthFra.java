 ...
 */
public class HealthFra extends Fragment {

    ListView listview;

    String url_health="https://api.tianapi.com/health/?key=d72674b671da40526f97fc9ebb7721b3&num=10";
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View frView = inflater.inflate(R.layout.fragment_health, null);
        listview=(ListView)frView.findViewById(R.id.lv_health);
        getNetData(url_health);
        return frView;
    }
    ...
    private void getNetData(String url) {
        OkGo.get(url).tag(this).execute(new StringCallback() {
            ...
            public void onSuccess(String arg0, Call arg1, Response arg2) {
                ...
                HealthFra.MyBaseAdapter adapter = new HealthFra.MyBaseAdapter(main.getNewslist());
