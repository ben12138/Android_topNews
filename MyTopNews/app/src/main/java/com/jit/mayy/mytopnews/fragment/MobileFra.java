 ...
 */
public class MobileFra extends Fragment {

    ListView listview;

    String url_mobile="https://api.tianapi.com/mobile/?key=d72674b671da40526f97fc9ebb7721b3&num=10";
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View frView = inflater.inflate(R.layout.fragment_mobile, null);
        listview=(ListView)frView.findViewById(R.id.lv_mobile);
        getNetData(url_mobile);
        return frView;
    }
    ...
    private void getNetData(String url) {
        OkGo.get(url).tag(this).execute(new StringCallback() {
            ...
            public void onSuccess(String arg0, Call arg1, Response arg2) {
                ...
                MobileFra.MyBaseAdapter adapter = new MobileFra.MyBaseAdapter(main.getNewslist());
