 ...
 */
public class KejiFra extends Fragment {

    ListView listview;

    String url_keji="https://api.tianapi.com/keji/?key=d72674b671da40526f97fc9ebb7721b3&num=10";
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View frView = inflater.inflate(R.layout.fragment_keji, null);
        listview=(ListView)frView.findViewById(R.id.lv_keji);
        getNetData(url_keji);
    ...
    private void getNetData(String url) {
        OkGo.get(url).tag(this).execute(new StringCallback() {
            ...
            public void onSuccess(String arg0, Call arg1, Response arg2) {
                ...
                KejiFra.MyBaseAdapter adapter = new KejiFra.MyBaseAdapter(main.getNewslist());
