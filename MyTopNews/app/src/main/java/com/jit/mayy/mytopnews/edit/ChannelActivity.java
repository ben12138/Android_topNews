package com.jit.mayy.mytopnews.edit;
...
import com.jit.mayy.mytopnews.MainActivity;
import com.jit.mayy.mytopnews.R;
import com.jit.mayy.mytopnews.adapter.DragAdapter;
import com.jit.mayy.mytopnews.adapter.OtherAdapter;
...
import com.jit.mayy.mytopnews.view.DragGrid;
import com.jit.mayy.mytopnews.view.OtherGridView;
...
public class ChannelActivity extends GestureDetectorActivity implements AdapterView.OnItemClickListener {
    ...
    public void onBackPressed() {
        ...
        if (userAdapter.isListChanged()) {
            ...
            setResult(Page1Fragment.CHANNELRESULT, intent);
            finish();
        } else {
            super.onBackPressed();
        }
