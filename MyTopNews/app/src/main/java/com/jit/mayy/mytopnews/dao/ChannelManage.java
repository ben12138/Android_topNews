package com.jit.mayy.mytopnews.dao;
...
public class ChannelManage {
    ...
    static {
        ...
        defaultUserChannels.add(new ChannelItem(3, "苹果", 3, 1));
        defaultUserChannels.add(new ChannelItem(4, "奇闻", 4, 1));
        defaultUserChannels.add(new ChannelItem(5, "科技", 5, 1));
        defaultUserChannels.add(new ChannelItem(6, "旅行", 6, 1));
        ...
        defaultOtherChannels.add(new ChannelItem(10, "游玩", 3, 0));
